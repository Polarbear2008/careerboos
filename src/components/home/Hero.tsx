          ...
          <div className="animate-slideUp delay-100">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap gap-2 justify-center mt-4">
                ...
                {activeTab === "talent" ? (
                  <>
                    <Button variant="link" size="sm" className="h-auto p-0">Web Development</Button>
                    <Button variant="link" size="sm" className="h-auto p-0">UI/UX Design</Button>
                    <Button variant="link" size="sm" className="h-auto p-0">Data Science</Button>
                    <Button variant="link" size="sm" className="h-auto p-0">Content Writing</Button>
                  </>
                ) : (
                  <>
                    <Button variant="link" size="sm" className="h-auto p-0">Mobile App</Button>
                    <Button variant="link" size="sm" className="h-auto p-0">Website Redesign</Button>
                    <Button variant="link" size="sm" className="h-auto p-0">Logo Design</Button>
                    <Button variant="link" size="sm" className="h-auto p-0">Marketing</Button>
                  </>
                )}
              </div>
            </div>
